const fallbackMessages = {
  ...
  statusDownloadingMessage: "下载会在 Chrome 后台继续，完成后本页会自动更新。",
  statusPreparingTitle: "正在准备模型",
  statusPreparingConnecting: "Chrome 正在下载或安装模型，但尚未提供可显示的百分比。请保持浏览器打开。",
  statusPreparingProgress: "模型下载进度：$1%",
  statusRemainingProgress: "剩余内容下载进度：$1%",
  statusRemainingProgressHint: "该百分比按重新连接时的剩余内容计算，不代表模型总进度。",
  statusInstallingTitle: "下载完成，正在安装模型",
  statusInstallingMessage: "Chrome 已报告下载完成，正在解压、安装或加载模型；状态会自动更新。",
  progressUnknown: "进度未知，正在处理中",
  preparationElapsed: "准备已用时：$1",
  ...
  cardClose: "关闭卡片",
  explanationDispatching: "正在开始解释…",
  modelRuntimePreparing: "Chrome 正在连接本地模型，启动或恢复可能需要一些时间…",
  modelGenerating: "本地模型已接收请求，正在生成解释…",
  modelResponseSlow: "本地模型仍在生成，首次输出可能稍慢…",
  cancelGeneration: "取消生成",
  shortLabel: "简短解释",
  shortCopy: "复制简短解释",
  shortRegenerate: "重新生成简短解释",
  explanationGenerating: "正在生成解释...",
  explanationStreaming: "解释正在持续生成…",
  ...
  errorModelStartupTimeout: "连接本地模型超时，请重试。",
  errorFirstTokenTimeout: "本地模型长时间没有响应，请重试。",
  errorStreamStalled: "设备端模型停止输出，请重试。",
  errorRequestCancelled: "已取消生成，可以重新尝试。",
  preparationInterrupted: "模型准备过程意外中断，请重试。",
